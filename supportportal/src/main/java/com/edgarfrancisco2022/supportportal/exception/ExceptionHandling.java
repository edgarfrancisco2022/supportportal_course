package com.edgarfrancisco2022.supportportal.exception;
...
//    @ExceptionHandler(NoHandlerFoundException.class) //define mvc properties en application.yml
//    public ResponseEntity<HttpResponse> methodNotSupportedException(NoHandlerFoundException e) {
//        return createHttpResponse(METHOD_NOT_ALLOWED, "This page was not found".toUpperCase());
//    }
...
*/
    ...
    @Override
    public String getErrorPath() { // for unknown paths
        return ERROR_PATH;
    }
}
