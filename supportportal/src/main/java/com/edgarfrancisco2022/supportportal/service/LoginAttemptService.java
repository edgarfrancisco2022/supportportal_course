...
public class LoginAttemptService {
    ...
    private LoadingCache<String, Integer> loginAttemptCache; //uses guava dependency
    ...
    public void evictUserFromLoginAttemptCache(String username) {
        loginAttemptCache.invalidate(username); //removes entire entry, no matter how many attempts are recorded
    }
