...
import static com.edgarfrancisco2022.supportportal.constant.EmailConstant.*;
...
public class EmailService {
    ...
    private Message createEmail(String firstName, String password, String email) throws MessagingException {
        ...
        message.setRecipients(TO, InternetAddress.parse(email, false)); //strict email pattern
